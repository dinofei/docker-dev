          ...
          DialogService.confirm(
            ...
            function accept() {
              ConsumerService
                ...
                .then(
                  function onSuccess(result) {
                    MessageService.success('OAuth2授权删除成功');
                    fetchOAuth2()
                  }
                )
          ...
          DialogService.confirm(
            ...
            function accept() {
              ConsumerService
                ...
                .then(
                  function onSuccess(result) {
                    MessageService.success('JWT授权删除成功');
                    fetchJWTs()
                  }
                )
          ...
          DialogService.confirm(
            ...
            function accept() {
              ConsumerService
                ...
                .then(
                  function onSuccess(result) {
                    MessageService.success('关键字授权删除成功');
                    fetchKeys()
                  }
                )
        ...
        function updateConsumerDetails() {
          ConsumerService.update($scope.consumer.id, {
            ...
            .then(function (res) {
              ...
              MessageService.success("客户端更新成功!")
            }).catch(function (err) {
